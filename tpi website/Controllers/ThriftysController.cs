...
{
    public class ThriftysController : Controller
    {
        private readonly tpi_websiteContext _context;

        public ThriftysController(tpi_websiteContext context)
        {
            _context = context;
        }
